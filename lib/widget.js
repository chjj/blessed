...
Element.prototype.__defineGetter__('ileft', function() {
  return this.left + (this.border ? 1 : 0) + this.padding;
});

Element.prototype.__defineGetter__('itop', function() {
  return this.top + (this.border ? 1 : 0) + this.padding;
});

Element.prototype.__defineGetter__('iright', function() {
  return this.right - (this.border ? 1 : 0) - this.padding;
});

Element.prototype.__defineGetter__('ibottom', function() {
  return this.bottom - (this.border ? 1 : 0) - this.padding;
});

Element.prototype.__defineGetter__('iwidth', function() {
  return this.width - (this.border ? 2 : 0) - this.padding * 2;
});

Element.prototype.__defineGetter__('iheight', function() {
  return this.height - (this.border ? 2 : 0) - this.padding * 2;
});
...
ScrollableBox.prototype.scroll = function(offset) {
  ...
  if (this.childBase !== base && this.screen.cleanSides(this)) {
    ...
    // var i = p.xi + (this.border ? 1 : 0) + this.padding;
...
Textbox.prototype._listener = function(ch, key) {
  ...
  // if (this.value !== value) {
  //   var i = -(this.width - (this.border ? 2 : 0) - this.padding * 2 - 1);
...
Textbox.prototype.render = function() {
  ...
  var visible = -(this.width - (this.border ? 2 : 0) - this.padding * 2 - 1);
  this.setContent(this.value.slice(visible));
  return this._render();
};
...
Textarea.prototype._typeScroll = function() {
  // XXX Workaround
  var width = this.height - (this.border ? 2 : 0) - this.padding * 2;
...
Listbar.prototype.select = function(offset) {
  ...
  width = width - (this.border ? 2 : 0) - this.padding * 2;
